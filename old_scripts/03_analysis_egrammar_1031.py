...
import egrammartools as egram

# we need to replicate the matrixmachine: produce a one line per file matrix to feed the clustermachine
# add categories 
# this is the relevant part of the matrix_machine
